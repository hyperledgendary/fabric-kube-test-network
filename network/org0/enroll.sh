...
#
ENROLLMENTS_DIR=${PWD}/network/org0/enrollments
...
#
ORG_CA_CERT=$(connection_profile_cert org0-ca .tls.cert)
echo $ORG_CA_CERT | base64 -d > $ENROLLMENTS_DIR/org0-ca-tls-cert.pem
